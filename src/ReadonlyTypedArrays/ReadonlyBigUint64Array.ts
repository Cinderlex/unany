export interface ReadonlyBigUint64Array {
    ...
    filter(
        predicate: (value: bigint, index: number, array: ReadonlyBigUint64Array) => any,
        thisArg?: any
    ): ReadonlyBigUint64Array;

    find(
        predicate: (value: bigint, index: number, obj: ReadonlyBigUint64Array) => boolean,
        thisArg?: any
    ): bigint | undefined;
    ...
    map(
        callbackfn: (value: bigint, index: number, array: ReadonlyBigUint64Array) => bigint,
        thisArg?: any
    ): ReadonlyBigUint64Array;
    ...
    reduce<U>(
        callbackfn: (previousValue: U, currentValue: bigint, currentIndex: number, array: ReadonlyBigUint64Array) => U,
        initialValue: U
    ): U;
